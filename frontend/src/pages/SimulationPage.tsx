  ...
  return (
    <div className="space-y-6 select-none">
          ...
          <div>
            <div className="flex items-center space-x-2">
              <h2 className="text-base font-bold text-slate-900 font-sans">
                Corridor Disruption &amp; What-If Simulation Sandbox
              </h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 bg-white border border-slate-200/90 rounded-3xl p-6 shadow-xs space-y-5 font-sans">
          <div className="border-b border-slate-100 pb-3">
            <h3 className="text-xs font-bold text-slate-900 uppercase tracking-wider">
              Shift Possession Window
            </h3>
          ...
          <div className="bg-slate-50 p-4 rounded-2xl border border-slate-200 text-xs space-y-2 font-mono">
            <div className="flex justify-between">
              <span className="text-slate-500 font-sans">Base Window:</span>
          ...
          {simulationResult && (
            ...
            >
              ...
              <span>Commit Shift to Live Timetable</span>
            </button>
          )}
        </div>
